...
Version  : 0.10.56
Release  : 81
URL      : https://cran.r-project.org/src/contrib/tseries_0.10-56.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tseries_0.10-56.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715720660
