...
Version  : 0.10.48
Release  : 52
URL      : https://cran.r-project.org/src/contrib/tseries_0.10-48.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tseries_0.10-48.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607362671
