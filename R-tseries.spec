...
Version  : 0.10.57
Release  : 82
URL      : https://cran.r-project.org/src/contrib/tseries_0.10-57.tar.gz
Source0  : https://cran.r-project.org/src/contrib/tseries_0.10-57.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723558082
